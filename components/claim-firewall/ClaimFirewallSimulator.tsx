...
const examples: Record<ExampleId, {
  ...
  runtime: {
    ...
    original: "Blocked example: HO-DET-001 is runtime active.",
  ...
  customer: {
    label: "customer-status overclaim",
    original: "Blocked example: Hoxline is customer deployed.",
  ...
  production: {
    ...
    original: "Blocked example: this detection is production ready.",
  ...
  ai: {
    ...
    original: "Blocked example: AI approved the final disposition.",
  ...
  signal: {
    ...
    original: "Blocked example: signal was observed publicly.",
