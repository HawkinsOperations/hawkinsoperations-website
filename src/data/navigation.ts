...
export const externalLinks = {
  ...
  lifetimeLedgerSummary: "https://github.com/HawkinsOperations/hawkinsoperations-proof/blob/main/proof/records/lifetime-case-ledger-v1-public-summary.json",
  lifetimeLedgerProofBundle: "https://github.com/HawkinsOperations/hawkinsoperations-proof/blob/main/proof/records/lifetime-case-ledger-v1-proof-bundle.json",
  lifetimeLedgerBadges: "https://github.com/HawkinsOperations/hawkinsoperations-proof/actions/workflows/governance-gate.yml?query=branch%3Amain",
