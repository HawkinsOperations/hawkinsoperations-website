...
export const proofRecords: ProofRecord[] = [
  ...
  },
  {
    ...
    title: "Suspicious Scheduled Task Creation - proof record present",
    proofLevel: proofCeiling,
    proofRecordState: "PROOF_RECORD_PRESENT",
    validationState: "controlled-test validation - 8 fixtures",
    runtimeState: "NOT_PROVEN / blocked",
    signalState: "NOT_PROVEN / blocked",
    publicSafeState: "NOT_PUBLIC_SAFE / blocked",
    sourceRepoLink: externalLinks.detections,
    proofRepoLink: externalLinks.proofRecordHoDet012,
    blockedPromotions: blockedClaims,
    exists: [
    ...
    notClaimed: [
      ...
      "Live Splunk, Wazuh, Cribl, Security Onion, production, autonomous SOC, AI-approved disposition, and analyst-approved disposition are not claimed.",
    ],
    remainingBlocked: [
      "Runtime evidence must be reviewed separately before any runtime wording can advance.",
      "Signal evidence must be reviewed separately before any signal wording can advance.",
      "Public-safe review, stale review, wording review, and Raylee approval are still required for any stronger claim.",
    ],
    promotionRequirements: [
      "Separate runtime evidence review if runtime wording is requested.",
      "Separate signal evidence review if signal wording is requested.",
      "Public wording reviewed against the blocked-claim list.",
    ],
  },
  {
