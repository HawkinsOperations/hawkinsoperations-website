...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    proves: "A controlled clean remote marker was delivered through the Cribl-to-Splunk lab lane and observed in expected Splunk rawdata with marker fields preserved.",
