...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    title: "HO-DET-001 Controlled Lab Runtime Match",
    category: "proof-record",
    truthSurface: "Runtime Truth",
    status: "blocked-pending-promotion",
    proofCeiling: "PROVEN_PRIVATE_INTERNAL",
    description: "Verifier-backed controlled lab runtime match for HO-DET-001 in Splunk. Private/internal scope; not a public-safe runtime proof.",
    proves: "HO-DET-001 produced a controlled lab runtime match in Splunk.",
    ...
    tags: ["HO-DET-001", "controlled-lab", "private-internal"],
  },
  {
    slug: "cribl-to-splunk-marker-delivery",
    title: "Controlled Cribl-to-Splunk Marker Delivery",
    category: "proof-record",
    truthSurface: "Evidence Truth",
    status: "blocked-pending-promotion",
    proofCeiling: "PROVEN_PRIVATE_INTERNAL",
    description: "Controlled clean remote marker delivered through the Cribl-to-Splunk lab lane. Private/internal lane verification; does not promote production claims.",
    proves: "A controlled clean remote marker was delivered through the Cribl-to-Splunk lab lane and observed in expected Splunk marker evidence with marker fields preserved.",
    ...
    tags: ["HO-DET-001", "cribl", "controlled-lab", "private-internal"],
  },
  {
