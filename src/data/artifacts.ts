...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    status: "supported",
    proofCeiling: "TEST_VALIDATED_SYNTHETIC_SCOPE",
    description: "Cloud detection proof record. Fixture-only CloudTrail-style validation with the public ceiling held at synthetic scope.",
    ...
    tags: ["AWS-DET-001", "validation", "synthetic", "cloud"],
  },
  {
  ...
  },
  {
    ...
    doesNotProve: "HO-DET-001/Sysmon telemetry is Cribl-routed, Cribl-routed telemetry for production or fleet scope, Wazuh live collection as public proof, live Splunk fired as public proof, or any change to the public proof ceiling.",
